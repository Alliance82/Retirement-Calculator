    ...
    def calc_invest():
        ...
        while age < end_age:
            ...
            if age <= retirement_age:
                ...
                compound_savings = savings__float * (1 + pre_interest_rate[4])
            ...
            savings.append((inv_nam, age, round(compound_savings,2)))

        # Create a DataFrame to plot
        df = pd.DataFrame(savings, columns=['account', 'age', 'savings'])
        total_income = df.loc[df['age'] == retirement_age, 'savings'].sum()    
